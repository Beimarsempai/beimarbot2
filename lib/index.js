...
//_INFORMACIONES DEL BOT(settings)
const prefix = '='
...
const crfig = "Sticker creado🔧"
const crlv = "Nuevo Nivel🥳"
const crtt = "Jogo da velha By: Beimar"
...
tiringa.on('group-participants-update', async (anu) => {
      ...
      tiringa.on('chat-update', async (mek) => {
		try {
           ...
           mess = {
                zen: 'Vtnc Zen',
				tterro: `Debes poner ${prefix}ppt pedra, ${prefix}ppt papel o ${prefix}ppt tesoura`,
				wait: `⏳Aguarde algunos instantes...⏳\n\nSi no funciona usa el comando nuevamente.`,
			    ...
			    waitfig: `⏳Aguarde algunos instantes...⏳\n\nLa creacion de stickers demora algunos segundos.`,
				...
				erro: {
                    ban: '🛂Seras baneado🛂',
					stick: '❌Ocurrio un error al crear stiker❌',
					Iv: '❌Link inválido❌'
				},
				only: {
                    zen: 'vtnc Zen',
...
esh = `Bunas tarde ${pushname}`
} else if(hoAtual => 18 && hoAtual < 23) {
esh = `Buenas noshes ${pushname}`
}
...
║╭╼╾╼╾╼╾╼╾╼╾╼╾╼╾
║├► ${prefix}info
║│_Informaciones del bot_
║├► ${prefix}criador
║│_Número di creador_
║├► ${prefix}ping
║│_Mostra tiempo de respuesta_
║├► ${prefix}infome
║│_Mostra algumas informações suas_
║├► ${prefix}infogp
║│_Mostra algunas informaciones del grupo_
║╰╼╾╼╾╼╾╼╾╼╾╼╾╼╾
╚═════ ≪ •❈• ≫ ═════╝
